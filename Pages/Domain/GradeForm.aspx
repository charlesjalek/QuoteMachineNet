   ...
   <telerik:RadGrid ID="RadGrid1" runat="server" AllowFilteringByColumn="True" AllowPaging="True" AllowSorting="True" AutoGenerateDeleteColumn="True"
       ...
       <MasterTableView AutoGenerateColumns="False" DataSourceID="SqlDataSource1" DataKeyNames="c_id" CommandItemDisplay="TopAndBottom" EditMode="PopUp">
           ...
           <Columns>
               ...
               <telerik:GridBoundColumn DataField="c_bl_grade_code" FilterControlAltText="Filter c_bl_grade_code column" HeaderText="c_bl_grade_code" ShowNoSortIcon="False" SortExpression="c_bl_grade_code" UniqueName="c_bl_grade_code">
               </telerik:GridBoundColumn>
               <telerik:GridBoundColumn DataField="c_bl_grade_describe" FilterControlAltText="Filter c_bl_grade_describe column" HeaderText="c_bl_grade_describe" ShowNoSortIcon="False" SortExpression="c_bl_grade_describe" UniqueName="c_bl_grade_describe">
               </telerik:GridBoundColumn>
           </Columns>
