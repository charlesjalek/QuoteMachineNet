...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder2" runat="server">
    ...
    <telerik:RadGrid ID="RadGrid1" runat="server" AllowFilteringByColumn="True" AllowPaging="True" AllowSorting="True" AutoGenerateDeleteColumn="True"
        AutoGenerateEditColumn="True" DataSourceID="SqlDataSource1" ShowGroupPanel="True" PageSize="15"  Height="800px"
        ...
        <MasterTableView AutoGenerateColumns="False" DataSourceID="SqlDataSource1" DataKeyNames="c_id" CommandItemDisplay="TopAndBottom" EditMode="PopUp">
            ...
            <Columns>
                ...
                <telerik:GridBoundColumn DataField="c_finisher_contact_name" FilterControlAltText="Filter c_finisher_contact_name column" HeaderText="Contact name" ShowNoSortIcon="False" SortExpression="c_finisher_contact_name" UniqueName="c_finisher_contact_name">
                </telerik:GridBoundColumn>
