<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/MasterPage.Master" CodeBehind="FinishersForm.aspx.vb" Inherits="BL.QuoteMachine.Finishers" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder2" runat="server">
    ...
    <telerik:RadGrid ID="RadGrid1" runat="server" AllowFilteringByColumn="True" AllowPaging="True" AllowSorting="True" AutoGenerateDeleteColumn="True"
        ...
        AllowAutomaticDeletes="True" AllowAutomaticInserts="True" AllowAutomaticUpdates="True" Skin="Office2010Blue" CellSpacing="-1" GridLines="Both">
        ...
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="Data Source=localhost;Initial Catalog=quotemachine;Integrated Security=True;" ProviderName="System.Data.SqlClient" 
            SelectCommand="SELECT * FROM [tbl_finishers]" ConflictDetection="CompareAllValues" 
            DeleteCommand="DELETE FROM [tbl_finishers] WHERE [c_id] = @original_c_id AND [c_finisher_code] = @original_c_finisher_code AND [c_finisher_name] = @original_c_finisher_name 
            AND [c_finisher_address] = @original_c_finisher_address AND [c_finisher_city] = @original_c_finisher_city AND [c_finisher_state] = @original_c_finisher_state 
            AND [c_finisher_zip] = @original_c_finisher_zip AND [c_finisher_contact_name] = @original_c_finisher_contact_name AND [c_finisher_contact_email] = @original_c_finisher_contact_email 
            AND [c_finisher_contact_phone] = @original_c_finisher_contact_phone" 
            ...
            @c_finisher_contact_email, @c_finisher_contact_phone)" OldValuesParameterFormatString="original_{0}" 
            ...
            [c_finisher_contact_phone] = @c_finisher_contact_phone WHERE [c_id] = @original_c_id AND [c_finisher_code] = @original_c_finisher_code AND [c_finisher_name] = @original_c_finisher_name 
            AND [c_finisher_address] = @original_c_finisher_address AND [c_finisher_city] = @original_c_finisher_city AND [c_finisher_state] = @original_c_finisher_state AND [c_finisher_zip] = @original_c_finisher_zip 
            AND [c_finisher_contact_name] = @original_c_finisher_contact_name AND [c_finisher_contact_email] = @original_c_finisher_contact_email AND [c_finisher_contact_phone] = @original_c_finisher_contact_phone">
            <DeleteParameters>
                <asp:Parameter Name="original_c_id" Type="Int32" />
                <asp:Parameter Name="original_c_finisher_code" Type="String" />
                <asp:Parameter Name="original_c_finisher_name" Type="String" />
                <asp:Parameter Name="original_c_finisher_address" Type="String" />
                <asp:Parameter Name="original_c_finisher_city" Type="String" />
                <asp:Parameter Name="original_c_finisher_state" Type="String" />
                <asp:Parameter Name="original_c_finisher_zip" Type="String" />
                <asp:Parameter Name="original_c_finisher_contact_name" Type="String" />
                <asp:Parameter Name="original_c_finisher_contact_email" Type="String" />
                <asp:Parameter Name="original_c_finisher_contact_phone" Type="String" />
            </DeleteParameters>
            <InsertParameters>
